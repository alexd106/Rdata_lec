...
.large[
`write.table(flowers_red, 'output/flowers2.txt', col.names = TRUE, row.names = FALSE)`
]

.medium[
- saves `flowers_red` data frame to a file named 'flowers.txt' in the output directory
